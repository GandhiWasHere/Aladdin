        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartProduct_Cart_ProductCartsCartID",
                        column: x => x.ProductCartsCartID,
                        principalTable: "Cart",
                        principalColumn: "CartID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartProduct_Product_CartProductsProductID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductSuppliersSupplierID = table.Column<int>(type: "int", nullable: false),
                    SupplierProductsProductID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSupplier", x => new { x.ProductSuppliersSupplierID, x.SupplierProductsProductID });
                    table.ForeignKey(
                        name: "FK_ProductSupplier_Product_SupplierProductsProductID",
                        column: x => x.SupplierProductsProductID,
                        principalTable: "Product",
                        principalColumn: "ProductID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSupplier_Supplier_ProductSuppliersSupplierID",
                        column: x => x.ProductSuppliersSupplierID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSupplier_SupplierProductsProductID",
